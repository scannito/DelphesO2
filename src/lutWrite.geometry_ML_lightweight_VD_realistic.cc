...
void fatInit_geometry_ML_lightweight_VD_realistic(float field = 2.0, float rmin = 20.)
{
  // Layer properties
...
void lutWrite_geometry_ML_lightweight_VD_realistic(const char* filename = "lutCovm.dat", int pdg = 211, float field = 2.0, float rmin = 20.)
{

  // init FAT
  fatInit_geometry_ML_lightweight_VD_realistic(field, rmin);
  // write
