...
void fatInit_geometry_ML_bent_new_radii(float field = 2.0, float rmin = 20.)
{
  // Layer properties
  ...
  fat.AddLayer((char*)"ddd4", 11., x0MLMod2, xrho, resRPhiOT, resZOT, eff);
...
void lutWrite_geometry_ML_bent_new_radii(const char* filename = "lutCovm.dat", int pdg = 211, float field = 2.0, float rmin = 20.)
{

  // init FAT
  fatInit_geometry_ML_bent_new_radii(field, rmin);
  // write
