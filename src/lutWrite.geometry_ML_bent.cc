...
void fatInit_geometry_ML_bent(float field = 2.0, float rmin = 20.)
{
  // Layer properties
  ...
  fat.AddLayer((char*)"L03", 7., x0MLMod2, resRPhiOT, resZOT, eff);
  fat.AddLayer((char*)"L04", 11., x0MLMod2, resRPhiOT, resZOT, eff);
...
void lutWrite_geometry_ML_bent(const char* filename = "lutCovm.dat", int pdg = 211, float field = 2.0, float rmin = 20.)
{

  // init FAT
  fatInit_geometry_ML_bent(field, rmin);
  // write
