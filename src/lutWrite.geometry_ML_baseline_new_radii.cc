...
void fatInit_geometry_ML_baseline_new_radii(float field = 2.0, float rmin = 20.)
{
  // Layer properties
...
void lutWrite_geometry_ML_baseline_new_radii(const char* filename = "lutCovm.dat", int pdg = 211, float field = 2.0, float rmin = 20.)
{

  // init FAT
  fatInit_geometry_ML_baseline_new_radii(field, rmin);
  // write
